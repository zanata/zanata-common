...
/**
 * This suite runs all the JUnit 4 unit tests (specifically: not Integration
 * Test Category) found in this Maven module's classpath.
 *
...
public class CommonUtilUTSuite
{
}
